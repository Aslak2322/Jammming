...
function App() {
  ...
  return (
    <div className="App">
      ...
      clearPlaylist={clearPlaylist} tracks={filteredTracks} accessToken={accessToken} />

      <div className='flex'>
        <div>
          <h1>Create PlayList</h1>
          {isPlaylistSaved===false && <PlayList playlist={playList} setPlaylist={setPlayList} />}
          <button onClick={movePlaylist}>Save</button>
        </div>

        {isPlaylistSaved && <div> <PlayList playlist={playList} setPlaylist={setPlayList} />
